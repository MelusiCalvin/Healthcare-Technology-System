...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen bg-white lg:grid-cols-2">
      ...
      <section className="flex items-center justify-center px-5 py-10 sm:px-8"><div className="w-full max-w-md"><div className="mb-10 lg:hidden"><Brand /></div><div className="mb-8"><span className="grid h-11 w-11 place-items-center rounded-xl bg-primary-50 text-primary-600"><ShieldCheck className="h-6 w-6" /></span><h2 className="mt-5 text-3xl font-extrabold tracking-tight text-slate-950">Welcome back</h2><p className="mt-2 text-sm leading-6 text-slate-500">Sign in with your Ubuntu Health account to continue to your authorised workspace.</p></div><Suspense fallback={null}><LoginForm /></Suspense><p className="mt-8 text-center text-xs leading-5 text-slate-400">By continuing, you confirm that you are authorised to access this healthcare system. All activity is logged and monitored.</p></div></section>
    </main>
  );
}
