      ...
      <section className="hidden bg-primary-700 p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-14">
        <div>
          ...
          <div className="mt-24 max-w-lg">
            ...
            <h1 className="mt-4 text-5xl font-extrabold tracking-tight">
              Better-connected care for every South African.
            </h1>

            <p className="mt-6 max-w-md text-lg leading-8 text-primary-100">
              One secure workspace for clinicians, care teams and the people
              they serve.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3 text-sm text-primary-100">
          <p className="flex items-center gap-2">
            ...
            Role-aware access for every care setting
          </p>

          <p className="flex items-center gap-2">
            <CheckCircle2 className="h-5 w-5 text-primary-200" />
            Designed for public and private healthcare
          </p>

          <p className="flex items-center gap-2">
            <CheckCircle2 className="h-5 w-5 text-primary-200" />
            Privacy and audit controls built in
          </p>
        </div>
      </section>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Sign in with your Ubuntu Health account to continue to your
          ...
          <p className="mt-8 text-center text-xs leading-5 text-slate-400">
            By continuing, you confirm that you are authorised to access this
            healthcare system. All activity is logged and monitored.
          </p>
        </div>
      </section>
    </main>
